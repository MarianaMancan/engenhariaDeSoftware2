...
DROP TABLE IF EXISTS `tbl_contas_a_pagar`;
...
-- Copiando dados para a tabela bd_cabelow.tbl_contas_a_pagar: ~0 rows (aproximadamente)
DELETE FROM `tbl_contas_a_pagar`;
/*!40000 ALTER TABLE `tbl_contas_a_pagar` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_contas_a_pagar` ENABLE KEYS */;

-- Copiando estrutura para tabela bd_cabelow.tbl_contas_a_receber
DROP TABLE IF EXISTS `tbl_contas_a_receber`;
...
-- Copiando dados para a tabela bd_cabelow.tbl_contas_a_receber: ~0 rows (aproximadamente)
DELETE FROM `tbl_contas_a_receber`;
/*!40000 ALTER TABLE `tbl_contas_a_receber` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_contas_a_receber` ENABLE KEYS */;
...
-- Copiando dados para a tabela bd_cabelow.tbl_fornecedores: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela bd_cabelow.tbl_pessoas: ~1 rows (aproximadamente)
DELETE FROM `tbl_pessoas`;
/*!40000 ALTER TABLE `tbl_pessoas` DISABLE KEYS */;
INSERT INTO `tbl_pessoas` (`id_pessoa`, `nome`, `email`, `celular`, `cpf_cnpj`, `nascimento`, `observacoes`, `logradouro`, `bairro`, `numero`) VALUES
	(1, 'Mariana', 'marianamancan@gmail.com', '11971101197', '42072606845', '2003-05-23', 'aluna mariana', 'rua curitiba', 'planalto', '136');
...
-- Copiando dados para a tabela bd_cabelow.tbl_produtos: ~0 rows (aproximadamente)
...
DROP TABLE IF EXISTS `tbl_tipo_pagamento`;
...
-- Copiando dados para a tabela bd_cabelow.tbl_tipo_pagamento: ~0 rows (aproximadamente)
DELETE FROM `tbl_tipo_pagamento`;
/*!40000 ALTER TABLE `tbl_tipo_pagamento` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_tipo_pagamento` ENABLE KEYS */;
